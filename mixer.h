...
#define MIXER_OUTPUT_SAMPLE_RATE_NTSC CLOWNMDEMU_PSG_SAMPLE_RATE_NTSC
#define MIXER_OUTPUT_SAMPLE_RATE_PAL CLOWNMDEMU_PSG_SAMPLE_RATE_PAL
#define MIXER_DIVIDE_BY_LOWEST_FRAMERATE CLOWNMDEMU_DIVIDE_BY_PAL_FRAMERATE
#define MIXER_MAXIMUM_AUDIO_FRAMES_PER_FRAME MIXER_DIVIDE_BY_LOWEST_FRAMERATE(CC_MAX(MIXER_OUTPUT_SAMPLE_RATE_NTSC, MIXER_OUTPUT_SAMPLE_RATE_PAL))
