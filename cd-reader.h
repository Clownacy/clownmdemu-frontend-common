...
cc_bool CDReader_ReadSector(CDReader_State *state, CDReader_Sector *sector);
cc_bool CDReader_ReadSectorAt(CDReader_State *state, CDReader_Sector *sector, CDReader_SectorIndex sector_index);
